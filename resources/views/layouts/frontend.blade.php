...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ url('/frontend/images/content/favicon.ico') }}" />
    <!-- Place favicon.ico in the root directory -->

    <link rel="icon" href="{{ url('/frontend/images/content/favicon.ico') }}" />

    <meta name="theme-color" content="#000" />
    <link rel="stylesheet" href="{{ url('/frontend/images/content/favicon.ico') }}">

        ...
        <div class="container mx-auto py-5">
            <div class="flex flex-stretch items-center">
                <div class="w-56 items-center flex">
                    <a href="{{ route('index') }}">
                        <img src="{{ url('/images/logo.png') }}" width="200" alt="PanelKendali" />
                    </a>
                </div>
                ...
                <div class="w-auto">
                    <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                        ...
                        <li class="mx-3 py-6 md:py-0">
                            <a href="/" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Home</a>
                        </li>
                        <li class="mx-3 py-6 md:py-0">
                            <a href="/product" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Produk</a>
                        </li>
                        @auth
                            <li class="mx-3 py-6 md:py-0">
                            ...
                            <li class="mx-3 py-6 md:py-0">
                                <a href=" {{ url('user/profile') }} " class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Profile</a>
                            </li>  
                        @endauth
                        @guest
                        <li class="mx-3 py-6 md:py-0">
                            <a href=" {{ route('login') }} " class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Masuk</a>
                        </li>
                        <li class="mx-3 py-6 md:py-0">
                            <a href=" {{ route('register') }} " class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Mendaftar</a>
                        </li>
                        {{-- <div class="w-max flex item-center">
                            <input type="text" class="w-full px-4 py-3 mx-4 leading-tight text-sm text-white bg-gray-900 rounded placeholder-white focus:outline-none focus:shadow-outline" placeholder="search">
                        </div>  --}}
                        @endguest
                    </ul>
                </div>

...
@section('content')
    ...
    <section class="flex items-center hero">
        <div
            ...
            <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
                Panel Kendali <br class="" />Layanan Otomasi Industri
            </h1>
            <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
                Kami menyediakan pelayanan Otomasi Industri
                <br class="hidden lg:block" />Penggunaan mesin, sistem kontrol untuk optimisasi produksi.
            </h2>
            <div>
                <a href="#browse-the-product"
                    style="background-color:#FFCA99"
                    class="text-black rounded-full px-8 py-3 mt-4 inline-block flex-none">Explore
                    Now</a>
            </div>
        </div>
        <div class="w-full inset-0 md:relative md:w-1/2">
            <div class="relative hero-image">
                ...
                <div class="overlay right-0 bottom-0 md:inset-0">
                    <button class="video hero-cta focus:outline-none z-30 modal-trigger" data-content='<div class="w-screen h-96 md:w-96 relative z-50">
                        <div class="absolute w-full h-full">
                                <iframe
                                width="100%"
                                height="100%"
                                src="https://www.youtube.com/embed/x0Yi786LQX4"
                                frameborder="0"
                ...
                <img src="/frontend/images/content/hero-img.jpg" alt="hero 1"
    ...
    <section class="flex bg-gray-100 py-16 px-4" id="browse-the-product">
        <div class="container mx-auto">
            <div class="flex flex-start mb-4">
                <h3 class="text-2xl capitalize font-semibold">
                    browse the product <br class="" />that we designed for you
                </h3>
            </div>
            <div class="grid grid-rows-2 grid-cols-9 gap-4">
                <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        <div class="bg-black-600 bg-white bg-opacity-75 rounded p-3">
                            <h5 class="text-lg font-semibold text-center">Otomasi tetap</h5>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                    <div class="card-shadow rounded-xl">
                        <img src="/frontend/images/content/image-catalog-4.jpg" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div
                        ...
                        <div class="bg-black-600 bg-white bg-opacity-75 rounded p-3">
                            <h5 class="text-lg font-semibold text-center">Otomasi Industri</h5>
                            <span class="text-center"></span>
                        </div>
                    </div>
                    <a href="#" class="stretched-link">
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                    <div class="card-shadow rounded-xl">
                        <img src="/frontend/images/content/image-catalog-2.jpg" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div
                        class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
                        <div class="bg-black-600 bg-white bg-opacity-75 rounded p-3">
                            <h5 class="text-lg font-semibold text-center">Otomasi Industri</h5>
                            <span class="text-center">Yang dapat diprogram</span>
                        </div>
                    </div>
                    <a href="#" class="stretched-link">
                        <!-- fake children -->
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        <div class="bg-black-600 bg-white bg-opacity-75 rounded p-3">
                            <h5 class="text-lg font-semibold text-center">Otomasi Fleksibel</h5>
                            <span class="text-center"></span>
                        </div>
                    </div>
                    <a href="#" class="stretched-link">
    ...
    <section class="flex flex-col py-16">
        <div class="container mx-auto mb-4">
            <div class="flex justify-center text-center mb-4">
                <h3 class="text-2xl capitalize font-semibold">
                    Jelajahi Produk <br class="" /> Yang Tersedia
                </h3>
            </div>
        </div>
        <div class="container mx-auto">
                <!-- DIV LAYAR LARGE -->
                <div class="grid gap-y-4 gap-x-1 grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
                    <!-- START: JUST ARRIVED ROW 1 -->
                    @foreach ($products->take(4) as $product )    
                    <div class="w-11/12 md:w-9/12 lg:w-11/12 rounded-xl overflow-hidden card-shadow shadow-md relative group mx-auto md:mx-2">
                        <div class="w-full">
                        {{-- <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px"> --}}
                            <div class="absolute opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
                        ...
                        <div class="p-4">
                            <h5 class="text-lg font-semibold w-11/12 truncate">{{ $product->name }}</h5>

...
<section class="bg-gray-100 py-8 px-4">
    <div class="container mx-auto">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="#" class="lowercase">{{ $product->category->name }}</a>
            </li>
            <li>
...
<section class="container mx-auto">
    <div class="flex flex-wrap my-4 md:my-12">
        ...
        <div class="flex-1">
            <div class="slider">
                ...
                @foreach ($product->galleries as $item)
                    <div class="px-2">
                        <div class="item {{ $loop->first ? 'selected' : '' }}" data-img="{{ $item->url }}">
                ...
                <div class="preview">
                    <div class="item rounded-lg h-full overflow-hidden">
                        <img src="{{ $product->galleries()->exists() ? $product->galleries->first()->url : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}" alt="front"
                            class="object-cover w-full h-full rounded-lg" />
                    </div>
                </div>
            </div>
        ...
        <div class="flex-1 px-4 md:p-6">
            <h2 class="text-5xl font-semibold">{{ $product->name }}</h2>
            <p class="text-xl pt-5 inline-flex">
            ...
            <p class="text-xl pt-5">IDR {{ number_format($product->price) }}</p>
            ...
            <button 
                ...
                class="text-black focus:text-black-400 rounded-full px-8 py-3 mt-4 inline-flex"><svg
    ...
    <div class="container mx-auto">
        <div class="flex flex-start mb-4">
            <h3 class="text-2xl capitalize font-semibold">
                Rekomendasi <br class="" />Produk Lainnya
            </h3>
        </div>
            ...
            <div class="px-3 flex-none" style="width: 320px">
                <div class="rounded-xl p-4 pb-8 relative bg-white">
                    <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                        <img src="{{ $recommendation->galleries()->exists() ? $recommendation->galleries->first()->url : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
                    <h5 class="text-lg font-semibold mt-4 w-11/12 truncate">{{ $recommendation->name }}</h5>
